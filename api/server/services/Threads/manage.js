 ...
 * @param {import('aipyq-data-provider').TFile[]} [params.files] - Optional. List of Attached File Objects.
...
/**
 * Records Aipyq messageId to all response messages' metadata
 *
 * @param {Object} params - The parameters for initializing a thread.
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.messageId - The response `messageId` generated by Aipyq.
...
/**
 * Synchronizes Aipyq messages to Thread Messages.
 * Updates the Aipyq DB with any missing Thread Messages and
 ...
 * @param {TMessage[]} params.dbMessages - The Aipyq DB messages.
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.endpoint - The current endpoint.
 * @param {string} [params.latestMessageId] - Optional: The latest message ID from Aipyq.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.run_id - Response Run ID.
 * @param {string} params.conversationId - Aipyq conversation ID.
 * @return {Promise<TMessage[]>} A promise that resolves to the updated messages
 */
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {RunClient} params.client - The Aipyq client that manages the run: either refers to `OpenAI` or `StreamRunManager`.
