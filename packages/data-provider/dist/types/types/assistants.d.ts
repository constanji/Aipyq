...
export type AgentCreateParams = {
    ...
    model: string | null;
    model_parameters: AgentModelParameters;
} & Pick<Agent, 'agent_ids' | 'edges' | 'end_after_tools' | 'hide_sequential_outputs' | 'artifacts' | 'recursion_limit' | 'category' | 'support_contact'>;
...
} | Agents.AgentUpdate | Agents.MessageContentImageUrl;
