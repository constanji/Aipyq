...
import type { IBalance, AppConfig } from '@librechat/data-schemas';
 ...
 */
export declare function createSetBalanceConfig({ getAppConfig, Balance, }: BalanceMiddlewareOptions): (req: ServerRequest, res: ServerResponse, next: NextFunction) => Promise<void>;
